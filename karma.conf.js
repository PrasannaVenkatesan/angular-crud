...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        './src/main/resources/static/js/staffController.js',
        './src/main/resources/static/js/staffService.js',
        
        './src/main/resources/static/junittest/staff.controller.test.js'
    ],
    ...
    preprocessors: {  
        './src/main/resources/static/js/staffController.js': ['coverage']
    },
    coverageReporter: {  
        type: 'lcov',
            dir: 'coverage',
